<script>
  ...
  $: maturityAmount = principal * (1 + interestRate/100 * years);
    ...
    <div class="container">
        ...
        <div class="loan">
          <a href={$url('../')}> <h3>Home</h3> </a>
            ...
            <div class="input1">
              <input type="number" bind:value={principal} class="u-full-width" placeholder="Enter Amount">
            </div>
        </div>
        <div class="year">
...
<style>
  ...
  .u-range-width{
    ...
    .container{
      ...
      border-radius: 15px;
      margin: 50px auto;
      background-color: rgba(222, 182, 211, 0.922);
    }
